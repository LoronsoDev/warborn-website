...
const Index = () => (
  <SiteLayout>
    <Seo
      title="Warborn España | Servidores Arma Reforger Normal y Milsim"
      description="Warborn: comunidad española de Arma Reforger. Servidores Normal y Milsim PvE en español. Únete a la mejor comunidad hispana de simulación táctica."
      path="/"
    />
    <HeroSection />
    <ServersSection />
    ...
    <SeoContent
      ...
      intro="Warborn es la principal comunidad hispana de Arma Reforger, con servidores españoles dedicados en modo Normal y Milsim PvE. Si buscas servidores de Arma Reforger en España con jugadores que hablan español, baja latencia y una comunidad activa 24/7, este es tu sitio."
      sections={[
        {
          h2: "Servidores Arma Reforger España",
          body: "Disponemos de servidores Arma Reforger españoles para todos los perfiles: jugadores casuales en el servidor Normal y operaciones planificadas en Milsim PvE. Todos los servidores Warborn están alojados en Europa, monitorizados en tiempo real y abiertos a la comunidad hispana de Arma Reforger.",
        },
        {
      ...
      faqs={[
        { q: "¿Qué es Warborn?", a: "Warborn es la comunidad española de Arma Reforger más grande, con servidores Normal y Milsim PvE en español." },
