...
const Mods = () => (
  <SiteLayout>
    <Seo
      ...
      description="Lista completa y actualizada de mods de los servidores Warborn de Arma Reforger. Descarga e instala los mods necesarios para jugar en Normal y Milsim."
      path="/mods"
    />
    <div className="pt-24">
      ...
      <SeoContent
        ...
        intro="Aquí encontrarás todos los mods utilizados en los servidores Warborn de Arma Reforger, organizados por categoría y servidor (Normal, Milsim). Los mods se descargan automáticamente al conectar, pero puedes consultarlos aquí para conocer su contenido."
        faqs={[
